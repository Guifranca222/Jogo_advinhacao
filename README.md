...
Como Funciona
O Desafio: O computador escolhe um número aleatório entre 0 e 100.
Limite de Tentativas: Você tem no máximo 10 tentativas para acertar.
Feedback Dinâmico:
...
Verifique o Python:python --version

Crie o arquivo:
Salve o código em um arquivo chamado jogo.py.

Acesse a pasta pelo Terminal:cd caminho/da/sua/pasta

Inicie o jogo:python jogo.py
